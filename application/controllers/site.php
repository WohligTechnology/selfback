...
//		$data['table']=$this->user_model->viewusers();
    ...
    public function viewuseraddressjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
    ...
    public function viewwishlistjson()
    {
    ...
    public function viewcreditjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
    ...
    public function viewproductjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
...
$status = $this->input->get_post('status');
    ...
    public function viewproductimagejson()
    {
        $id = $this->input->get('id');
        $elements = array();
        $elements[0] = new stdClass();
...
$elements[3] = new stdClass();
    ...
    public function viewdesignerjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
    ...
    public function viewdesignsjson()
    {
        $id = $this->input->get('id');
        $elements = array();
        $elements[0] = new stdClass();
...
if ($this->homeslide_model->edit($id, $name, $description, $link, $sorder, $target, $status, $image, $template, $class, $text, $centeralign) == 0) {
    ...
    public function viewcategoryjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
...
$config['upload_path'] = './uploads/';
    ...
    public function viewofferproductjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
    ...
    public function viewsubcategoryjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
...
LEFT OUTER JOIN `fynx_order` ON `fynx_order`.`id` = `fynx_orderitem`.`order` WHERE `fynx_orderitem`.`order`= $row->id AND `fynx_orderitem`.`status`=3")->result();
...
$data['before1'] = $this->input->get('id');
    ...
    public function vieworderitemjson()
    {
        $id = $this->input->get('id');
        $elements = array();
        $elements[0] = new stdClass();
...
$data['product'] = $this->product_model->getproductdropdown();
    ...
    public function viewasksumanjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
...
$search = $this->input->get_post('search');
    ...
    public function viewnewsletterjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
    ...
    public function viewsizechartjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
...
//$image=$this->input->get_post("image");
    ...
    public function uploadproductcsvsubmit()
    {
        $access = array('1');
        $this->checkaccess($access);
        $config['upload_path'] = './uploads/';
...
//        echo $id1;
    ...
    public function viewsubscribejson()
    {
        $elements = array();
        $elements[0] = new stdClass();
...
// PRODUCT DESIGN IMAGE
    ...
    public function viewproductdesignimagejson()
    {
        $id = $this->input->get('id');
        $elements = array();
        $elements[0] = new stdClass();
...
$data['redirect'] = 'site/viewproductdesignimage?id='.$this->input->get('productid');
    ...
    public function viewtestimonialjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
...
if ($this->testimonial_model->edit($id, $name, $location, $description, $weight) == 0) {
    ...
    public function viewhealthpackagesjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
...
$search = $this->input->get_post('search');
    ...
    public function viewsubtypejson()
    {
        $elements = array();
        $elements[0] = new stdClass();
...
$this->load->view('templatewith2', $data);
    ...
    public function viewcommentjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
    ...
    public function viewrelatedblogjson()
    {
        $id = $this->input->get('id');
...
$data['page'] = 'editplan';
    ...
    public function viewimagepulljson()
    {
        $elements = array();
        $elements[0] = new stdClass();
    ...
    public function viewrecipesjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
...
if ($this->recipes_model->edit($id, $name, $description, $ingredients, $method, $valueperserve, $status, $image1) == 0) {
    ...
    public function viewrecipeimage()
    {
        $access = array('1');
        $this->checkaccess($access);
        $data['page'] = 'viewrecipeimage';
        $data['page2'] = 'block/recipeblock';
        $data['before1'] = $this->input->get('id');
        $data['before2'] = $this->input->get('id');
        $data['base_url'] = site_url('site/viewrecipeimagejson?id=').$this->input->get('id');
        $data['title'] = 'View Recipe Image';
        $this->load->view('templatewith2', $data);
    }
    public function viewrecipeimagejson()
    {
        $id = $this->input->get('id');

        $elements = array();
        $elements[0] = new stdClass();
        $elements[0]->field = '`recipes_image`.`id`';
        $elements[0]->sort = '1';
        $elements[0]->header = 'id';
        $elements[0]->alias = 'id';
        $elements[1] = new stdClass();
        $elements[1]->field = '`recipes_image`.`image`';
        $elements[1]->sort = '1';
        $elements[1]->header = 'image';
        $elements[1]->alias = 'image';

        $elements[2] = new stdClass();
        $elements[2]->field = '`recipes_image`.`sorder`';
        $elements[2]->sort = '1';
        $elements[2]->header = 'sorder';
        $elements[2]->alias = 'sorder';

        $elements[3] = new stdClass();
        $elements[3]->field = '`recipes_image`.`recipe`';
        $elements[3]->sort = '1';
        $elements[3]->header = 'recipeid';
        $elements[3]->alias = 'recipeid';
        ...
        $data['message'] = $this->chintantable->query($pageno, $maxrow, $orderby, $orderorder, $search, $elements, 'FROM `recipes_image` ', "WHERE `recipes_image`.`recipe`='$id'");
        $this->load->view('json', $data);
    }

    public function createrecipeimage()
    {
        $access = array('1');
        $this->checkaccess($access);

        $data['page'] = 'createrecipeimage';
        $data['page2'] = 'block/recipeblock';
        $data['title'] = 'Create Recipe Image';
        $data['before1'] = $this->input->get('id');
        $data['before2'] = $this->input->get('id');
        $this->load->view('templatewith2', $data);
    }
    public function createrecipeimagesubmit()
    {
        $access = array('1');
        $this->checkaccess($access);
        $this->form_validation->set_rules('image', 'image', 'trim');
        if ($this->form_validation->run() == false) {
            ...
            $recipe = $this->input->get_post('recipe');
            $order = $this->input->get_post('order');
            $status = $this->input->get_post('status');
            $config['upload_path'] = './uploads/';
            $config['allowed_types'] = 'gif|jpg|png|jpeg';
        ...
        $this->load->library('image_lib', $config_r);
            ...
            if ($this->recipeimage_model->create($recipe, $order, $status, $image) == 0) {
                $data['alerterror'] = 'New Recipe Image could not be created.';
            } else {
                $data['alertsuccess'] = 'Recipe Image created Successfully.';
            }
            $data['redirect'] = 'site/viewrecipeimage?id='.$recipe;
            $this->load->view('redirect2', $data);
        }
    }
    public function editrecipeimage()
    {
        $access = array('1');
        $this->checkaccess($access);
        $data['blog'] = $this->blogtag_model->getblogdropdown();
        $data['relatedtag'] = $this->tags_model->gettagdropdown();
        $data['page'] = 'editrecipeimage';
        $data['page2'] = 'block/recipeblock';
        $data['title'] = 'Edit Recipe Image';
        $data['before'] = $this->recipeimage_model->beforeedit($this->input->get('id'));
        $data['before1'] = $this->input->get('id');
        $data['before2'] = $this->input->get('id');
        $this->load->view('templatewith2', $data);
    }
    public function editrecipeimagesubmit()
    {
        $access = array('1');
        $this->checkaccess($access);
        $this->form_validation->set_rules('id', 'id', 'trim');
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($image == '') {
                $image = $this->recipeimage_model->getimagebyid($id);
                    // print_r($image);
                     $image = $image->image;
            }

            if ($this->recipeimage_model->edit($id, $order, $status, $image) == 0) {
                $data['alerterror'] = 'New Recipe Image could not be Updated.';
            } else {
                $data['alertsuccess'] = 'Recipe Image Updated Successfully.';
            }
            $data['redirect'] = 'site/viewrecipeimage?id='.$recipe;
            $this->load->view('redirect2', $data);
        }
    ...
    public function deleterecipeimage()
    {
        $access = array('1');
        $this->checkaccess($access);
        $this->recipeimage_model->delete($this->input->get('id'));
        $data['redirect'] = 'site/viewrecipeimage?id='.$this->input->get('recipeid');
        $this->load->view('redirect', $data);
    }
    ...
    public function viewcareersjson()
    {
        $elements = array();
        $elements[0] = new stdClass();
...
$elements[4]=new stdClass();
$elements[4]->field="`fynx_coupon`.`count`";
$elements[4]->sort="1";
$elements[4]->header="Count";
$elements[4]->alias="count";
$search=$this->input->get_post("search");
$pageno=$this->input->get_post("pageno");
$orderby=$this->input->get_post("orderby");
$orderorder=$this->input->get_post("orderorder");
...
$data[ 'status' ] =$this->user_model->getstatusdropdown();
$data[ 'currency' ] =$this->coupon_model->getcurrencydropdown();
...
if($this->coupon_model->create($type,$min,$max,$discount,$name,$status,$coupon,$currency)==0)
...
$coupon=$this->input->get_post("coupon");
$currency=$this->input->get_post("currency");
if($this->coupon_model->edit($id,$type,$min,$max,$discount,$name,$status,$coupon,$currency)==0)
