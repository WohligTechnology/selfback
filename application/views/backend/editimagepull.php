<div class="row">
<div class="col s12">
<h4 class="pad-left-15 capitalize">Edit Image</h4>
</div>
</div>
<div class="row">
<form class='col s12' method='post' action='<?php echo site_url("site/editimagepullsubmit");?>' enctype= 'multipart/form-data'>
