<div class="row">
<div class="col s12">
<h4 class="pad-left-15 capitalize">Create Plan</h4>
</div>
...
<a href="<?php echo site_url("site/viewplan?id=").$this->input->get("id"); ?>" class="btn btn-secondary waves-effect waves-light red">Cancel</a>
</div>
</div>
</form>
</div>
