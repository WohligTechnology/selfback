...
<input type="text" id="name" name="name" value='<?php echo set_value('name',$before->title);?>'>
</div>
</div>
...
<input type="text" id="year" name="year" value='<?php echo set_value('order',$before->year);?>'>
</div>
</div>
