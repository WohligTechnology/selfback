...
//send email to register
		 ...
		 $message = "<html><body><div id=':1fn' http://wohlig.co.in/selfcare/#/homeclass='a3s adM' style='overflow: hidden;'><div class='HOEnZb'><div class='adm'><div id='q_152da6db6beee01c_0' class='ajR h4' data-tooltip='Hide expanded content' aria-label='Hide expanded content'><div class='ajT'></div></div></div><div class='im'><u></u>
		 <div style='margin:0'>
...
//            echo "New password and confirm password do not match!!!";
		...
		public function updateorderstatusafterpayment($OrderId, $nb_order_no, $responsecode, $Amount)
    {
        ...
        if (intval($Amount)  > 0 ) {
            ...
            redirect('http://selfcareindia.com/#/thankyou/'.$OrderId.'/'.$Amount);
        } else {
