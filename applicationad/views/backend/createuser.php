...
-->
        <div class="row">
			<div class="input-field col m6 s12">
				...
				<input type="text" id="billingline1" name="billingline1" value="<?php echo set_value('billingline1');?>">
			</div>
		</div>
        <div class="row">
			<div class="input-field col m6 s12">
				<label for="billingline2">Billing line 2</label>
				<input type="text" id="billingline2" name="billingline2" value="<?php echo set_value('billingline2');?>">
			</div>
		</div>
        <div class="row">
			<div class="input-field col m6 s12">
				<label for="billingline3">Billing line 3</label>
				<input type="text" id="billingline3" name="billingline3" value="<?php echo set_value('billingline3');?>">
			</div>
		</div>
        <div class="row">
			<div class="input-field col m6 s12">
